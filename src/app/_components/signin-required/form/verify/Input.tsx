            ...
            {verify.isPending ? (
                ...
                otp.map((code, index) => (
                    <input
                        ...
                        className="w-[60px] h-[60px]  bg-slate-700 border border-slate-600 text-white focus:border-blue-600 text-center text-3xl text-gray-800 pt-1 transition duration-200"
                        key={index}
                        id="otpCode"
                        type="text"
                        inputMode="numeric"
